...
class BuyInvoicesListArchiveView(View):
...
class DeleteItemsInvoiceBuyView(View):
...
class DeleteInvoiceBuyView(View):
...
class SellInvoicesListArchiveView(View):
...
class MakeVerificationView(View):
