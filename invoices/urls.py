...
urlpatterns = [
    ...
    path("record_fv_sell/", sell_invoices_list, name="sell_invoices_list"),
    ...
    path("record_accounting_note/", corrective_note_list, name="corrective_note_list"),
    path("info_note/<int:id>/", show_info_note, name="show_info_note"),
    path("record_accounting_note_archive/<int:year>", corrective_note_list_archive, name="corrective_note_list_archive"),
    path("new_accounting_note/", new_note, name="new_note"),
    path("edit_accounting_note/<int:id>/", edit_note, name="edit_note"),
    path("edit_accounting_note_archive/<int:id>/", edit_note_archive, name="edit_note_archive"),
