...
from .views import menu_invoices, buy_invoices_list, buy_invoices_list_archive, NewInvoiceBuyView, sell_invoices_list, \
    sell_invoices_list_archive, new_invoice_sell, edit_invoice_sell, edit_invoice_sell_archive, edit_invoice_buy, \
    make_verification, show_info_buy, \
    show_info_sell, corrective_note_list, corrective_note_list_archive, show_info_note, new_note, \
    edit_note, EditNoteArchiveView, make_pdf_from_invoices_sell, AddItemsInvoiceBuyView, delete_items_invoice_buy, \
    delete_invoice_buy
