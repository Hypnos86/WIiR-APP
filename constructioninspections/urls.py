...
from constructioninspections.views import create_buildings_one_year_inspections, buildings_inspections_choise, \
    create_buildings_five_year_inspections, create_chimney_inspection_list, create_electrical_inspection_one_year_list, \
...
urlpatterns = [
    ...
    path("buildings_inspections_five_year/", create_buildings_five_year_inspections,
         name="create_buildings_five_year_inspections"),
    path("chimneys_inspections/", create_chimney_inspection_list, name="create_chimney_inspection_list"),
    path("electrical_inspections/", create_electrical_inspection_one_year_list, name="create_electrical_inspection_list"),
