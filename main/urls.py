...
urlpatterns = [
    ...
    path('add_rent_car', add_rent_car, name='add_rent_car'),
    path('rent_car/<int:id>', edit_rent_car, name='edit_rent_car'),
    path('delete_rent_car/<int:id>', delete_rent_car, name='delete_rent_car'),
