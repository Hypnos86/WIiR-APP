...
class AccessModule(models.Model):
    ...
    listregister_float_team_module = models.BooleanField('Ewidencja: Zespół Mieszkaniowy - Podgląd', default=False)
    listregister_float_team_module_edit = models.BooleanField('Ewidencja: Zespół Mieszkaniowy - Edycja', default=False)
    listregister_exploatation_team_module = models.BooleanField('Ewidencja: Zespół Eksploatacji - Podgląd', default=False)
    contracts_immovables_module = models.BooleanField('Ewidencja: Zespół Nieruchomości - Podgląd', default=False)
    contracts_immovables_module_edit = models.BooleanField('Ewidencja: Zespół Nieruchomości - Edycja', default=False)
