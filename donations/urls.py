...
from donations.views import DonationsListView, AddDonationView, EditDonationView, ShowInformationView, DonationsArchiveYearListView, \
...
urlpatterns = [
    ...
    re_path('edit/(?P<year>[0-9]{4})/(?P<slug>[\w-]+)/$', EditDonationView.as_view(), name='edit_donation'),
