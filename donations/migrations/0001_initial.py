...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('character', models.CharField(max_length=25, unique_for_year='date_receipt', verbose_name='Nr. sprawy')),
                ('date_receipt', models.DateField(verbose_name='Data wpływu')),
                ('date_return', models.DateField(blank=True, null=True, verbose_name='Data zwrotu')),
                ('no_application', models.CharField(blank=True, max_length=10, null=True, verbose_name='Nr. wniosku')),
                ('no_agreement', models.CharField(blank=True, max_length=25, null=True, verbose_name='Nr. porozumienia')),
                ('date_agreement', models.DateField(blank=True, null=True, verbose_name='Data porozumienia')),
