...
from contracts.views import menu_contractsimmovables, new_contractsimmovables, edit_contractsimmovables, \
    show_contractsimmovables, new_aneks, menu_contracts_auction, new_contract_auction, show_contract_auction, \
    edit_contract_auction
...
urlpatterns = [
    ...
    path('new_aneks/', new_aneks, name='new_aneks'),
