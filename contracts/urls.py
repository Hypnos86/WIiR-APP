...
urlpatterns = [
    ...
    path("financial_doc/<int:contract_id>/", financial_document_list, name="financial_document_list"),
    path("new_financial_doc/<int:contract_id>/", add_financial_document, name="add_financial_document"),
    path("edit_financial_doc/<int:contract_id>/<int:id>/", edit_financial_document, name="edit_financial_document"),
