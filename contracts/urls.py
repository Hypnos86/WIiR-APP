...
urlpatterns = [
    ...
    path('dodaj_aneks/<int:id>', add_annex_immovables, name='add_annex_immovables'),
    ...
    path('dodaj_aneks_zzp/<int:id>', add_annex_contract_auction, name='add_annex_contract_auction')
]
